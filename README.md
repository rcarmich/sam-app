...
Most of this file was generated by "sam init" when creating my application.

To build and deploy, execute: "sam build && sam deploy".

See the video and presentation; my github page for this project is https://github.com/rcarmich/sam-app
